...
/**
  * Cette classe permet de gérer les input rentrés depuis le terminal
  * Ces inputs sont utilisés par un joueur Humain
  * Les fonctions permettent de récupérer différents type d'informations
  * nécessaire au jeu, comme des coordonnées, le nom d'un joueur, l'IA et ses
  * composantes voulues, etc.
  */
...
public class ScannerInput implements Input,Serializable{
  ...
  /**
    ...
    * Les paramètres file, mode et nomfichier permettent d'enregistrer ou de lire
    * le joueur et son type que l'utilisateur a décidé
