...
#############################################
	...
	Dans un terminal ou avec un IDE, compilez toutes les classes présentes dans le dossier Interface/src/application présent dans le trunk, puis exécutez la classe Main.

Le code fonctionne de manière sûre sur :
-Intellij
https://www.jetbrains.com/idea/download/
-E(fx)clipse
https://www.eclipse.org/efxclipse/install.html

Le jeu vous propose ensuite soit la version interface graphique, soit terminal.
